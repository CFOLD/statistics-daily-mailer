...
- Renders supported LaTeX math locally with KaTeX into inline images before assembling the email HTML
...
- `scripts/render_math_images.js`: local KaTeX math image renderer used during email generation
